...
import { getDesiredInterfaceState } from '@virtualmachines/details/tabs/configuration/network/utils/utils';
...
const NetworkInterfaceActions: FC<NetworkInterfaceActionsProps> = ({
  ...
  const interfaceState = getDesiredInterfaceState(templateVM, nicName);
