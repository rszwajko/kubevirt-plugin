...
export const VncConsole: FC<VncConsoleProps> = ({
  ...
  const disconnect = useCallback(
    ({
      ...
      kubevirtConsole.log(
        `[VncConsole] disconnect from ${sourceLabel}. Session already closed. Target session ${sessionID}, active session ${sessionRef.current}.`,
        rfbRefs.current,
      );
      ...
      targetAndOlderSessions.forEach(({ rfb }) => rfb?.disconnect());
  ...
  useEffect(() => {
    ...
    // and prevents re-creating the VncComponent.
