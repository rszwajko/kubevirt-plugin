...
const GroupMenuContent: React.FC<GroupMenuContentProps & { checkAccess: CheckAccess }> = ({
  checkAccess,
  onClick,
  option,
}) => (
...
const SubMenuContent: React.FC<GroupMenuContentProps & { checkAccess: CheckAccess }> = ({
  checkAccess,
  onClick,
  option,
}) => (
